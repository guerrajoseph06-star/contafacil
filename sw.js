 ...
 */
const SW_VERSION = '2026.07.05c';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260705c',
  './js/platform.js?v=20260705c',
  './js/db.js?v=20260705c',
  './js/app.js?v=20260705c',
  './js/tax.js?v=20260705c',
