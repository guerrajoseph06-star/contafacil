 ...
 */
const SW_VERSION = '2026.05.29g';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529g',
  './js/db.js?v=20260529g',
  './js/app.js?v=20260529g',
  './js/tax.js?v=20260529g',
];
