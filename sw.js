 ...
 */
const SW_VERSION = '2026.05.23x';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260523x',
  './js/db.js?v=20260523x',
  './js/app.js?v=20260523x',
  './js/tax.js?v=20260523x',
];
