 ...
 */
const SW_VERSION = '2026.07.02c';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260702c',
  './js/platform.js?v=20260702c',
  './js/db.js?v=20260702c',
  './js/app.js?v=20260702c',
  './js/tax.js?v=20260702c',
