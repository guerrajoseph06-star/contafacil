 ...
 */
const SW_VERSION = '2026.07.14b';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260714b',
  './js/platform.js?v=20260714b',
  './js/voz.js?v=20260714b',
  './js/db.js?v=20260714b',
  './js/app.js?v=20260714b',
  './js/tax.js?v=20260714b',
