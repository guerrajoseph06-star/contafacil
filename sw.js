 ...
 */
const SW_VERSION = '2026.05.29d';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529d',
  './js/db.js?v=20260529d',
  './js/app.js?v=20260529d',
  './js/tax.js?v=20260529d',
];
