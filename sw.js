 ...
 */
const SW_VERSION = '2026.05.23z';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260523z',
  './js/db.js?v=20260523z',
  './js/app.js?v=20260523z',
  './js/tax.js?v=20260523z',
];
