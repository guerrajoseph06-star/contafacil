 ...
 */
const SW_VERSION = '2026.05.29f';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529f',
  './js/db.js?v=20260529f',
  './js/app.js?v=20260529f',
  './js/tax.js?v=20260529f',
];
