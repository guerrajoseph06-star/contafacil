 ...
 */
const SW_VERSION = '2026.05.29b';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529b',
  './js/db.js?v=20260529b',
  './js/app.js?v=20260529b',
  './js/tax.js?v=20260529b',
];
