 ...
 */
const SW_VERSION = '2026.05.29h';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529h',
  './js/db.js?v=20260529h',
  './js/app.js?v=20260529h',
  './js/tax.js?v=20260529h',
];
