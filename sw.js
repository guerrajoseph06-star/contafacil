 ...
 */
const SW_VERSION = '2026.05.23t';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260523t',
  './js/db.js?v=20260523t',
  './js/app.js?v=20260523t',
  './js/tax.js?v=20260523t',
];
