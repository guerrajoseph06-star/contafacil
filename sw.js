 ...
 */
const SW_VERSION = '2026.05.23y';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260523y',
  './js/db.js?v=20260523y',
  './js/app.js?v=20260523y',
  './js/tax.js?v=20260523y',
];
