 ...
 */
const SW_VERSION = '2026.05.29e';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529e',
  './js/db.js?v=20260529e',
  './js/app.js?v=20260529e',
  './js/tax.js?v=20260529e',
];
