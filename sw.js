 ...
 */
const SW_VERSION = '2026.05.23w';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260523w',
  './js/db.js?v=20260523w',
  './js/app.js?v=20260523w',
  './js/tax.js?v=20260523w',
];
