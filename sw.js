 ...
 */
const SW_VERSION = '2026.07.05d';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260705d',
  './js/platform.js?v=20260705d',
  './js/db.js?v=20260705d',
  './js/app.js?v=20260705d',
  './js/tax.js?v=20260705d',
