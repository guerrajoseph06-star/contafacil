 ...
 */
const SW_VERSION = '2026.07.05e';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260705e',
  './js/platform.js?v=20260705e',
  './js/db.js?v=20260705e',
  './js/app.js?v=20260705e',
  './js/tax.js?v=20260705e',
