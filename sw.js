 ...
 */
const SW_VERSION = '2026.07.02d';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260702d',
  './js/platform.js?v=20260702d',
  './js/db.js?v=20260702d',
  './js/app.js?v=20260702d',
  './js/tax.js?v=20260702d',
