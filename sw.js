 ...
 */
const SW_VERSION = '2026.07.05b';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260705b',
  './js/platform.js?v=20260705b',
  './js/db.js?v=20260705b',
  './js/app.js?v=20260705b',
  './js/tax.js?v=20260705b',
