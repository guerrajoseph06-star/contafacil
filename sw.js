 ...
 */
const SW_VERSION = '2026.07.05a';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260705a',
  './js/platform.js?v=20260705a',
  './js/db.js?v=20260705a',
  './js/app.js?v=20260705a',
  './js/tax.js?v=20260705a',
