 ...
 */
const SW_VERSION = '2026.07.14a';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260714a',
  './js/platform.js?v=20260714a',
  './js/db.js?v=20260714a',
  './js/app.js?v=20260714a',
  './js/tax.js?v=20260714a',
