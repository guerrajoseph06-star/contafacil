 ...
 */
const SW_VERSION = '2026.05.29c';            // sincronizar con APP_VERSION de app.js
...
const SHELL = [
  ...
  './index.html',
  './manifest.json',
  './css/style.css?v=20260529c',
  './js/db.js?v=20260529c',
  './js/app.js?v=20260529c',
  './js/tax.js?v=20260529c',
];
